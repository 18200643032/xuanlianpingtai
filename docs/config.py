...
class Web_Config:
    ...
    paginate_url = "/api/online-train/instance/paginate?type=competition&pageSize=5"#获取训练ID的url，实例的状态
    train_url = "/api/online-train/instance/{instance_id}/train"#发起训练的url
    #aa =               "/api/online-coding/instance/{instance_id}/generate-train-mirror/real-time-log/false"#
